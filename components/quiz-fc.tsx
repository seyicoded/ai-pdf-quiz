...
import { Question, QuestionFC } from "@/lib/schemas";
...
const QuestionCard: React.FC<{
...
}> = ({ question, selectedAnswer, onSelectAnswer, showCorrectAnswer, handleNextQuestion }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl p-6 shadow-lg bg-[grey]"
    >
...
export default function QuizFC({
  questions,
  clearPDF,
  title = "Quiz",
}: QuizProps) {
